...
import { X, Upload, LogIn, LogOut, LayoutGrid, Columns, Loader2 } from 'lucide-react'
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-[hsl(var(--background))] text-[hsl(var(--foreground))]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-lg font-medium animate-pulse">正在加载相册...</p>
        </div>
      </div>
    )
  }
          ...
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div className="hidden md:block">
              <h2 className="font-semibold text-[hsl(var(--foreground))] text-base leading-tight truncate">
                {activeAlbum?.title || activeAlbum?.name || '全部照片'}
              </h2>
